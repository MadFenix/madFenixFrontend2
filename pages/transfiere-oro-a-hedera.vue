<template>
  <div class="min-h-screen bg-gray-100 p-4" v-if="user.user">
    ...
    <!-- Tarjeta: Transferir oro a Hedera -->
    <div class="bg-white shadow rounded p-6 mx-auto" style="width: 300px;">
      <h2 class="text-xl font-bold text-center mb-4">Transferir oro a Hedera</h2>
      <div class="space-y-4">
        <!-- Campo: Id de hedera -->
        <div class="mt-5">
          ...
          <div class="relative">
            ...
            />
            <!-- Ícono (ejemplo, simulando mdi-ticket) -->
            <svg
        ...
        <div class="mt-5">
          <label for="oro" class="block text-gray-700 mb-1">Cantidad de oro (Mínimo 1)</label>
          <div class="relative">
            <input
                id="oro"
                type="number"
...
export default {
  ...
  methods: {
    ...
    transferToHedrera(){
      this.api('/api/blockchain/transferOroToHedera', {
        method: 'POST',
