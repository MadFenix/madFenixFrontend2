<template>
  <div>
    ...
    <h2 class="leading-10 text-xl font-bold text-center mb-4 bg-madfenix-naranja py-6 h-[100px] flex items-center justify-center">Transferir Oro Hedera - Paso 1/3</h2>
    ...
    <div class="p-5 sm:p-20" v-if="user.user">
      <div class="relative rounded-tr-3xl sm:m-auto sm:w-1/2 border-2 border-madfenix-naranja bg-madfenix-gris overflow-hidden">
        ...
        <div class="p-6 py-[120px] relative z-50">
          <div class="w-full text-xl text-center text-madfenix-blanco">
          ...
          <div>
            <div class="grid grid-cols-12 gap-3 items-center mt-3">
              ...
              <div class="col-span-6 text-madfenix-blanco">
      ...
      <div class="relative sm:mx-auto sm:w-1/2 z-50 contenedor-botones-formularios">
        <div class="flex justify-center">
          ...
          <div class="contenedor-boton-right-formularios">
            <button @click="nextStep" class="flex items-center w-full m-auto justify-center px-8 py-4 btn-madfenix text-madfenix-gris font-semibold bg-madfenix-naranja leading-snug transition ease-in-out h-10 lg:h-14 duration-250 hover:text-madfenix-naranja hover:bg-madfenix-gris border-madfenix-naranja border-2">
              Siguiente
            </button>
          </div>
        </div>
...
export default {
  ...
  methods: {
    ...
    nextStep(){
      if (this.tokenAdded) {
        this.$router.push('/transfiere-oro-a-hedera-previo2')
      } else {
