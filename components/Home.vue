<template>
  <div>
    ...
    <section :class="`relative px-4 py-12 md:py-16 sm:px-6 lg:px-8 z-20`">
      <h2 :class="`sm:mt-[50px] md:mt-[150px] lg:mt-[300px] text-[color:var(--naranja)]`" id="title-nuestra-mision">
        Nuestra misión
      </h2>
      <div id="container-nuestra-mision" :class="`p-8 text-[color:var(--blanco)] bg-[color:var(--gris)]`">
    ...
    <section :class="`px-4 py-12 md:py-16 sm:px-6 lg:px-8`" id="container-nuestros-juegos">
      <h2 :class="`text-[color:var(--naranja)] w-full text-right`" id="title-nuestros-juegos">
        Nuestros juegos
      </h2>
        ...
        <div :class="`order-2 mt-12 overflow-hidden md:mt-0 md:order-1 md:col-span-9`">
          ...
          <div :class="`grid gap-6 lg:grid-cols-2 md:gap-8`">
            ...
            <div :class="`max-w-lg mx-auto shadow-xl rounded-3xl bg-dark-700`">
              ...
              <div :class="`w-full bg-[color:var(--gris)] p-6 lg:p-4 xl:p-6`">
    ...
    <div :class="`my-4 container mx-auto p-12`">
      <h2 :class="`text-[color:var(--naranja)]`">
      ...
      <div :class="`mt-8 grid grid-cols-1 sm:grid-cols-3 gap-3`">
        <div :class="`mt-3 p-8 text-white bg-[color:var(--gris)] border-2 border-[color:var(--naranja)] container-movemos-comunidades-modulos`">
          <h3 :class="`mb-3 w-full text-center text-[color:var(--naranja)]`">Ligas</h3>
          <p>
        ...
        <div :class="`mt-3 p-8 text-white bg-[color:var(--gris)] border-2 border-[color:var(--naranja)] container-movemos-comunidades-modulos`">
          <h3 :class="`mb-3 w-full text-center text-[color:var(--naranja)]`">Pase de Temporada</h3>
          <p>
    ...
    <section :class="`my-4 sm:my-12 container mx-auto`">
      <!-- Hero card -->
      <div :class="`bg-[color:var(--naranja)] flex`">
        <!-- Hero card content -->
    ...
    <section :class="`my-12 container mx-auto`">
      <h2 :class="`text-[color:var(--naranja)] w-full text-center`">
        Sellos del Fénix
      </h2>
      ...
      <div :class="`grow`">
        <!-- Hero card -->
        <div :class="`bg-[color:var(--naranja)] mt-3 p-5 mx-3 lg:px-24`">
          <div :class="`flex flex-col items-center justify-center lg:items-start`">
            <div :class="`z-30 w-full max-w-lg mx-auto text-center lg:text-left lg:max-w-none md:max-w-2xl`">
              <p :class="`text-2xl font-bold text-[color:var(--gris)]`">
                Los sellos del Fénix nacen como un <span :class="`text-[color:var(--gris)] font-bold`">distintivo de reconocimiento</span> a quienes ayuden a difundir el camino a la Unión Consciente
              </p>
            </div>
          </div>
        </div>
    ...
    <div :class="`z-30 container mx-auto mt-10 flex justify-center w-full`">
      <NuxtLink :to="'/sellos-fenix'" :class="`flex items-center justify-center w-auto px-8 py-4 text-base font-semibold leading-snug transition ease-in-out bg-[color:var(--naranja)] rounded-full h-14 duration-250 text-[color:var(--gris)] hover:text-[color:var(--blanco)] focus:outline-none hover:bg-[color:var(--gris)] border-2 border-[color:var(--gris)] hover:border-[color:var(--naranja)]`">
  ...
  methods: {
   ...
   setUserCookies() {
    ...
    completeHabit(habitId) {
      ...
      this.api('/api/host/habit/postComplete', {
        method: 'POST',
